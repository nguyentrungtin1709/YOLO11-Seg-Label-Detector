...
class ConfigService(IConfigService):
    ...
    def getPreprocessingMinWidth(self) -> int:
        """Get minimum width for upscaling in preprocessing."""
        return self.get("s3_preprocessing.minWidth", 300)
    
    def getPreprocessingMinHeight(self) -> int:
        """Get minimum height for upscaling in preprocessing."""
        return self.get("s3_preprocessing.minHeight", 200)
