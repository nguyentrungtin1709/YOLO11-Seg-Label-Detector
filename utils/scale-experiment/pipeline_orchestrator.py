...
class PipelineOrchestrator:
    ...
    def _initializeServices(
        ...
        self._s3PreprocessingService = S3PreprocessingService(
            ...
            minWidth=self._configService.getPreprocessingMinWidth(),
            minHeight=self._configService.getPreprocessingMinHeight(),
            debugBasePath=debugBasePath,
            debugEnabled=debugEnabled
        )
        ...
        self._s6ComponentExtractionService = S6ComponentExtractionService(
            ...
            aboveQrScaleFactor=self._configService.getAboveQrScaleFactor(),
            debugBasePath=debugBasePath,
            debugEnabled=debugEnabled
        )
